...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Mamba Music Bot")
...
#LOG_ID = int(getenv("LOG_ID", "-1001996954922"))
...
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "FantasticSukhi")
GIT_TOKEN = getenv(
    "GIT_TOKEN", None
)  # Fill this variable if your upstream repository is private

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/MAMBA_UPDATES")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/MAMBA_HELPCHAT")
...
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/5b2f2e9e64ca6e84c75d7.jpg")
